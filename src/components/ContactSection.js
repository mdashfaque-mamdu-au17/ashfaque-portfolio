    ...
    <section id="contact-me" className="pt-[121px] lg:pt-[160px]">
      ...
      <div className="px-8 mx-auto lg:flex lg:justify-between max-w-7xl">
        <div className="flex justify-center pt-[34px]">
          <img src={ManStandingMob} alt="man-standing" className="md:hidden" />
          <img
            src={ManStandingDesk}
            alt="man-standing"
        ...
        <div>
          ...
          >
            {(props) => {
              return (
                <Form>
                  <div className="flex flex-col items-center gap-9 pt-9">
                    <div>
                      <InputField
                        label="firstName"
                        name="firstName"
                    ...
                    <div>
                      <button
                        type="submit"
                        className="w-[168px] h-[51px] bg-theme-purple-800 rounded flex justify-center items-center"
                      >
                        <div className="flex items-center gap-5">
                          <p className="text-theme-white-700 text-lg leading-[26px]">
                            Send
                          </p>
